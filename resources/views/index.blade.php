                ...
                <div class="col-lg-12">
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title"><a href="{{route('category.single',['id'=>$web_development->id])}}">{{$web_development->name}}</a></h4>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                ...
                                @foreach($web_development->posts()->take(3)->get() as $post)
                    ...
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title"><a href="{{route('category.single',['id'=>$android_development->id])}}">{{$android_development->name}}</a></h4>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($android_development->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{asset($post->featured)}}" alt="{{$post->title}}">
                    ...
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title"><a href="{{route('category.single',['id'=>$ios_development->id])}}">{{$ios_development->name}}</a></h4>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                ...
                                @foreach($ios_development->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{asset($post->featured)}}" alt="{{$post->title}}">
